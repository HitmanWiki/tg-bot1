...
if (uniMsg == "/about" || uniMsg == "/about@" + botuname) {
  ...
  bot.sendAnimation(msg.chat.id, coverCommands[4], {caption: '*This bot is developed by:* [DINO EGG AI](www.dinoegg.org)' +
    ...
    '\n\nSupport by spreading the word, or Buy Some Eggs:' +
